...
public class ShineSwing {
    ...
    private void createAndShowGUI() {
        ...
        screenSizeMenu.add(new JMenuItem("128x160"));
        screenSizeMenu.add(new JMenuItem("240x320"));
        screenSizeMenu.add(new JMenuItem("360x640"));
        screenSizeMenu.add(new JMenuItem("Custom…"));

        JMenu orientationMenu = new JMenu("Orientation");
        orientationMenu.add(new JMenuItem("Portrait"));
        orientationMenu.add(new JMenuItem("Landscape"));

        JMenu zoomMenu = new JMenu("Zoom");
        zoomMenu.add(new JMenuItem("1x"));
        zoomMenu.add(new JMenuItem("2x"));
